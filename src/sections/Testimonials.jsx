  ...
  return (
    <div className="py-16 lg:py-24" id="testimonials">
      <div className="container">
        <SectionHeader eyebrow="Happy Clients" title="What Clients Say about Me" description="Don't take my word for it, see what my clients have to say about my work." />
                    ...
                    <Card key={testimonial.name} className="max-w-xs md:p-8 md:max-w-md hover:-rotate-3 transition duration-300">
                      <div className="flex gap-4 items-center">
                        ...
                        <div>
                          ...
                          <p className="text-white/10 text-sm">{testimonial.position}</p>
                        </div>
                      </div>
